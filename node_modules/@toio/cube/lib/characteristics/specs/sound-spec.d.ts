...
export declare class SoundSpec {
    playPresetSound(soundId: number): PlayPresetSoundType;
    playSound(operations: SoundOperation[], repeatCount: number): PlaySoundType;
    stopSound(): StopSoundType;
}
